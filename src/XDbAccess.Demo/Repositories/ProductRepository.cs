...
{
    public class ProductRepository : BaseRepository<DapperTest2DbContext>, IProductRepository
    {
        public ProductRepository(IDbHelper<DapperTest2DbContext> dbHelper) : base(dbHelper) { }
