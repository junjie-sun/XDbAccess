...
{
    public class UserRepository : BaseRepository<DapperTestDbContext>, IUserRepository
    {
        public UserRepository(IDbHelper<DapperTestDbContext> dbHelper) : base(dbHelper) { }
