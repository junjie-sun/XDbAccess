...
{
    public class OrderMySqlRepository : BaseRepository<DapperTest2DbContext>, IOrderRepository
    {
        public OrderMySqlRepository(IDbHelper<DapperTest2DbContext> dbHelper) : base(dbHelper) { }
