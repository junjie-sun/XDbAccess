...
namespace XDbAccess.Test.UnitTests
{
    public class MySqlDbHelperTest
    {
        ...
        public void UpdateByConditionTest()
        {
            ...
            var r = DbHelper.Update<User>(user2, false, "`Description`=@Description", new { Description = "Test2" });
            Assert.Equal(1, r);
        ...
        public async void UpdateByCondtionAsyncTest()
        {
            ...
            var r = await DbHelper.UpdateAsync<User>(user2, false, "`Description`=@Description", new { Description = "Test2" });
            Assert.Equal(1, r);
